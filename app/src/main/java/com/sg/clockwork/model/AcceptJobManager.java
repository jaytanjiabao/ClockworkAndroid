 ...
 */
public class AcceptJobManager extends AsyncTask<String, Void, String> {
    String authToken, email;
    int id;
    ProgressDialog dialog;
    JobActionListener jobActionListener;

    public AcceptJobManager(JobActionListener jobActionListener, ProgressDialog dialog) {
    ...
    protected void onPreExecute() {
        super.onPreExecute();
        dialog.setTitle("Sending job acceptance");
